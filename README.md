...
Note that as of July 2017 the Travis CI integration status is somewhat unstable due to updates in Travis CI Linux images used. In practice, this means that if you see Build failing status, there is nothing wrong with the code and the <span style="color:green">installation can complete successfully</span> on your machine. We are working to resolve this issue.</span>
